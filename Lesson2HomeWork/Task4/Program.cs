    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //если авторизация неуспешна, то писать осколько осталось попыток
                //если успешна, то писать об успехе и выходить из цикла
        ...
        /// <summary>
        /// Проверка авторизации по логину и паролю. Если проверка не проходит 
        /// пишет красивую надпись
        /// </summary>
